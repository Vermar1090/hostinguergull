...
// === GESTIÓN DE IMÁGENES ===
// src/controllers/productController.js - AGREGAR
...
const addProductImage = async (req, res) => {
    try {
        ...
        // Guardar con todos los tamaños
        const imageId = await Product.addImage(id, {
            imagen_url: req.file.path,
            thumbnail: req.file.thumbnail || req.file.path,
            medium: req.file.medium || req.file.path,
            orden: orden || 0
        });
